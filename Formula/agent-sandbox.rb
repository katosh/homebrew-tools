...
class AgentSandbox < Formula
  ...
  url "https://github.com/katosh/agent_sandbox/releases/download/v0.9.0/agent-sandbox-0.9.0.tar.gz"
  sha256 "e3fda8472f49d437ce6edf22c2566d5af25c881ef70003fd2b74685888aeddae"
  license "MIT"
