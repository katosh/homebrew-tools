...
#   3. Tag a release in the main repo: git tag -a v0.3.0 -m "Initial release" && git push --tags
#   4. Compute the sha256: curl -sL https://github.com/katosh/agent_sandbox/archive/refs/tags/v0.3.0.tar.gz | shasum -a 256
...
class AgentSandbox < Formula
  ...
  url "https://github.com/katosh/agent_sandbox/archive/refs/tags/v0.3.0.tar.gz"
  sha256 "bb642247604da72d6d83e2760ff4e44d1537bf8e0e8216a7697c0f76c831e9a7"
  license "MIT"
